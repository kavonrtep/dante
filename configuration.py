...
#JSON_CONF_R = """{"hooks" : {"modify": "function( track, f, fdiv ){var nm=feature.get('Name'); if (nm == 'LTR/copia/Bianca'){fdiv.style.background = 'red';} else { fdiv.style.background = 'blue';}}"}}"""
JSON_CONF_N = """{"hooks" : {"modify": "function( track, f, fdiv ) {fdiv.style.background = '#474747'}"}}"""
JSON_CONF_W = """{"hooks" : {"modify": "function( track, f, fdiv ) {fdiv.style.background = ['#00FF00', '#0000FF', '#FF0000', '#01FFFE', '#FFA6FE', '#FFDB66', '#006401', '#010067', '#95003A', '#007DB5']}"}}"""
...
N_GFF = "{}/{}".format(TMP,"N_regions.gff")
